...
namespace UserRegistration.Infrastructure.User
{
    public sealed class UserRepository : IUserRepository
    {
        ...
        public static Expression<Func<UserRegistration.Domain.Entities.User, UserModel>> Model => user => new UserModel
        {
            Id = user.Id,
            Name = user.Name,
            Email = user.Email
        ...
        public async Task AddAsync(UserRegistration.Domain.Entities.User user, CancellationToken cancellationToken) 
